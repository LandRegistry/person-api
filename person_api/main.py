...
from person_api.blueprints import register_blueprints
from person_api.extensions import register_extensions
from person_api.exceptions import register_exception_handlers
